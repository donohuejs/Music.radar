import { inferEventCategory, isNonPerformanceListing } from "./eventCategory.js";
...
export function normalizeEvent(event) {
  ...
  if (isNonPerformanceListing(event)) return null;
  ...
  return {
    ...event,
    name,
    artistName: cleanEventTitle(event.artistName, venueName) || name,
    venueName,
    ...
    category,
    genres: inferEventGenres({ ...event, category }),
  };
}
